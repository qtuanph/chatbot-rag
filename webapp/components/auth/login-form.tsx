...
export function LoginForm() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <Card className="overflow-hidden p-0 surface-elevated">
        <CardContent className="grid p-0 md:grid-cols-2">
          ...
          <div className="relative hidden overflow-hidden md:block">
            <div className="absolute inset-0 bg-gradient-to-br from-[#01387b] via-[#084ea4] to-[#01387b]" />
            <div
              className="absolute inset-0 opacity-90"
              style={{
                background:
                  "radial-gradient(circle at 80% 20%, rgba(255,94,21,0.35), transparent 55%), radial-gradient(circle at 20% 85%, rgba(255,129,84,0.25), transparent 60%)",
              }}
            />
            <div className="relative flex h-full flex-col justify-between gap-6 p-8 text-white">
              <div className="flex items-center gap-3">
                <div className="flex size-10 items-center justify-center rounded-lg bg-white/15 backdrop-blur-sm ring-1 ring-white/20">
                ...
                <div className="flex flex-col leading-tight">
                  ...
                  <span className="text-xs text-white/70">Multi-tenant RAG Platform</span>
                </div>
              </div>

              <div className="space-y-3">
                <div className="inline-flex w-fit items-center gap-2 rounded-full border border-white/20 bg-white/10 px-3 py-1 text-xs font-medium text-white/90 backdrop-blur">
                  <span className="size-1.5 rounded-full bg-[#ff5e15]" />
