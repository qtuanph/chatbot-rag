    ...
    def parse(
        ...
        try:
            ...
            metadata = ParsingMetadata(
                ...
                warnings=["Using fallback parser (not Docling); quality may be lower"],
            )

            logger.info("Parsed %s with classic parser: %d nodes (format: %s)", filename, len(nodes), source_format)
