...
class SettingsService:
    ...
    async def test_provider(self, provider_id: int) -> dict:
        ...
        # Keep test behavior aligned with runtime:
        # prefer active keys in api_keys table, then fallback to provider.api_key.
        ...
        try:
            if provider["service_type"] == "embedding":
                ...
                if provider.get("provider_name") == "nvidia":
                    # NVIDIA asymmetric embedding models require explicit input_type.
