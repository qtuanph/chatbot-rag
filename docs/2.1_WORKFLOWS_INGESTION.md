...
sequenceDiagram
    ...
    Worker->>AIEngine: embed_batch() (32/batch, async parallel)
    AIEngine-->>Worker: dense vectors (1024-dim)
...
| 9 | Embed | AITeamVNEmbedding (remote AI-Engine, 1024-dim, batch size 32) |
...
| 5 | Section grouping | Merge queries → dedupe → top 3 sections (score ≥ 0.25) |
