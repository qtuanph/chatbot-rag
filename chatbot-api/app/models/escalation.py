...
class Escalation(Base):
    ...
    question_variants: Mapped[list] = mapped_column(JSONB, server_default=text("'[]'::jsonb"), nullable=False)
    query_hashes: Mapped[list] = mapped_column(JSONB, server_default=text("'[]'::jsonb"), nullable=False)
    hit_count: Mapped[int] = mapped_column(server_default=text("0"), nullable=False)
