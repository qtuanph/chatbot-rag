...
class Settings(BaseSettings):
    ...
    allowed_hosts: str = "localhost,127.0.0.1,0.0.0.0,test,testserver,api.chatbot.sse.net.vn,9router.sse.net.vn,media.chatbot.sse.net.vn,console.media.chatbot.sse.net.vn,api"
