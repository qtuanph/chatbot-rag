...
export default function AdminDashboardPage() {
  ...
  return (
    <div className="mx-auto max-w-7xl space-y-6 p-6">
      <div>
        <h1 className="text-2xl font-bold">Tổng quan platform</h1>
        <p className="text-sm text-muted-foreground">Theo dõi sức khỏe hệ thống, tài liệu sẵn sàng và tenant usage nổi bật.</p>
      </div>
