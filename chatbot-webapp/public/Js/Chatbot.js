...
//                 console.error("❌ Lỗi khi điền dữ liệu:", err);
            ...
            document.body.insertAdjacentHTML('beforeend', `
                ...
                <div id="chatbot-box">
                    <div id="chatbot-header">
                        ...
                        <h3>🤖 Trợ Lý ERP</h3>
                        <p>Thử nghiệm (Beta) • Đóng góp ý kiến</p>
                    </div>
                    <div id="chatbot-messages">
                        <div class="message bot">
                            Xin chào! 🤖 Tôi là Trợ lý AI của SSE vừa được triển khai.<br><br>
                            Hệ thống đang trong giai đoạn hoàn thiện, rất mong nhận được góp ý của bạn để trợ lý ngày càng thông minh hơn!
        ...
        function resetChat() {
            ...
            welcomeText.innerHTML = 'Cuộc hội thoại mới đã bắt đầu! Bạn cần trợ giúp hoặc góp ý điều gì cho trợ lý AI?';
